...
public class TablaEstudiante {
	...
	final String SELECT_ESTUDIANTES_CARRERA_CIUDAD = "SELECT e FROM Estudiante e JOIN e.matriculas m JOIN m.carrera c WHERE c.nombre = :carrera AND e.ciudadDeResidencia = :ciudad ";
